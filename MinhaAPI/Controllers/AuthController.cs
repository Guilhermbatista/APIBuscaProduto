...
public class AuthController : ControllerBase
{
    ...
    public async Task<IActionResult>CreateRole(string roleName)
    {
        ...
        if (!roleExist)
        {
            ...
            else
            {
                ...
                {
                    Status = "Error",
                    Message = $"Issue adding the new {roleName} Rolle"
                });
            }
        }
        return StatusCode(StatusCodes.Status400BadRequest, new Response
    ...
    public async Task<IActionResult> Register([FromBody] RegisterModel model)
    {
        ...
        return Ok(new Response { Status = "Success" , Message = "UserCreated Successfully" });
    }
    ...
    public async Task<IActionResult> RefreshToken(TokenModel tokenModel)
    {
        ...
        var principal = _tokenService.GetPrincipalFromExpireToken(accessToken!, _configuration);

        if (principal == null)
        {
            return BadRequest("Invalid access token/refresh roken");
        }
